...
CryptoGraphy.prototype.decryptMsg = function(encryptMsg) {
  ...
  if (this.msgSignature !== tempSignature) {
    throw new Error('msgSignature is not invaild');
  }
  // 实例AES 解密对象
  ...
  var deEncryptedMsg = Buffer.concat([deCipheriv.update(encryptMsg, 'base64'), deCipheriv.final()]).toString('utf-8');
  // 获取填充字符串的位置
